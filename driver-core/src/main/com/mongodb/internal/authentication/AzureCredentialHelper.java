...
public final class AzureCredentialHelper {
    ...
    public static final class AzureCredentialInfo {
        private final String accessToken;
        private final Duration expiresIn;

        public AzureCredentialInfo(final String accessToken, final Duration expiresIn) {
        ...
        if (cachedValue.isPresent()) {
            ...
            try {
                ...
                if (cachedValue.isPresent()) {
                    ...
                    AzureCredentialInfo response = fetchAzureCredentialInfo(resource, objectId);
    ...
    public static AzureCredentialInfo fetchAzureCredentialInfo(final String resource, @Nullable final String objectId) {
        ...
        return new AzureCredentialInfo(accessToken, Duration.ofSeconds(expiresInSeconds));
    }
